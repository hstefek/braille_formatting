...
def reset_dictionary():
    ...
    syllableDict = {}
    w = csv.writer(open("HR_dictionary.csv", "w"))
    with open('HR_Txt-624.txt', 'r') as data:
        for line in data:
            ...
            w.writerow([key, '-'.join(map(str, rastav))])
    ...
    freq = csv.writer(open("HR_syllable_frequency.csv", "w"))
